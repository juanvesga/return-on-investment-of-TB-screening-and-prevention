function results=get_interventions_fast(x,sfin,path,prm,ref,sel,agg,gps,location,scen,hivpoints,fityr,endyr)
...
% for ii=  1:nsims
   ...
   p.country=location;
    ...
    getsol = @(Mfinal) ode15s(@(t,in)...
        goveqs_scaleup_itv(t, in, M0, Mfinal,[2023 2026], i,s,r,p, sel, agg,hivpoints),...
...
txt=sprintf('%s','itvfast','_',num2str(scen));
