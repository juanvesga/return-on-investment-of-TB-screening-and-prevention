...
function M = make_intervention2(p, r, i,s, gps,intvn)
...
elseif intvn == 1
    ...
    if(strcmp(p.country,"GEO")||strcmp(p.country,"BRA"))
     ...
     [r1, p1]=get_country_pars(r1,p1,p.country,'TPT_enhanced','plhiv');
...
elseif intvn == 2
   ...
   [r2, p2]=get_country_pars(r2,p2,p.country,'TPT_enhanced','hhc');
...
elseif intvn == 3
    ...
    p3.hiv_cov_screen=1;
     ...
     [r3, p3]=get_country_pars(r3,p3,p.country,'TPT_enhanced','hhc_plhiv');
...
elseif intvn == 4
    ...
    [r4, p4]=get_country_pars(r4,p4,p.country,'TPT_enhanced','slum');
