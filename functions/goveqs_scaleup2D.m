...
function out = goveqs_scaleup2D(t, in, M0, M1, M2, times, i, s,r, p, sel, agg,hivpoints)
...
Mt = M1; Mt.Dxlin = M0.Dxlin + scale(1)*(M1.Dxlin-M0.Dxlin) + scale(2)*(M2.Dxlin-M0.Dxlin);
out = governing_equations(t, in, Mt, i, s,r,p, sel, agg, p.growth,hivpoints);
