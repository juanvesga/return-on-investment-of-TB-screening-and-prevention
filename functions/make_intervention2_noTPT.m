...
function M = make_intervention2_noTPT(p, r, i,s, gps,intvn)
...
elseif intvn == 1
    ...
    if(strcmp(p.country,"GEO")||strcmp(p.country,"BRA"))
     ...
     [r1, p1]=get_country_pars(r1,p1,p.country,'noTPT_enhanced','plhiv');
    ...
    p1.case_findingPLHIV_I(1) =p.hiv_a0_enhanced_noart_sens;
    p1.case_findingPLHIV_I(2) =p.hiv_a5_enhanced_noart_sens;
    p1.case_findingPLHIV_I(3) =p.hiv_a10_enhanced_noart_sens;
    p1.case_findingPLHIV_I(4) =p.hiv_a15_enhanced_noart_sens;
...
elseif intvn == 2
    ...
    p2.hhc_a_cov_tpt=[p.hhcovu5,p.hhcov,p.hhcov,p.hhcov];
    p2.hhc_a_cov_screen=[1,1,1,1];

    [r2, p2]=get_country_pars(r2,p2,p.country,'noTPT_enhanced','hhc');
    ...
    p2.case_findingHHC_U(1,:,hhc_slum) = p.hhc_a0_enhanced_spec;
    p2.case_findingHHC_U(2,:,hhc_slum) = p.hhc_a5_enhanced_spec*(1-p.tbst_spec);
    p2.case_findingHHC_U(3,:,hhc_slum) = p.hhc_a10_enhanced_spec*(1-p.tbst_spec);
    p2.case_findingHHC_U(4,:,hhc_slum) = p.hhc_a15_enhanced_spec*(1-p.tbst_spec);

    p2.case_findingHHC_Lf(1,:,hhc_slum) = p.hhc_a0_enhanced_spec;
    p2.case_findingHHC_Lf(2,:,hhc_slum) = p.hhc_a5_enhanced_spec*p.tbst_sens;
    p2.case_findingHHC_Lf(3,:,hhc_slum) = p.hhc_a10_enhanced_spec*p.tbst_sens;
    p2.case_findingHHC_Lf(4,:,hhc_slum) = p.hhc_a15_enhanced_spec*p.tbst_sens;

    p2.case_findingHHC_Ls(1,:,hhc_slum) = p.hhc_a0_enhanced_spec;
    p2.case_findingHHC_Ls(2,:,hhc_slum) = p.hhc_a5_enhanced_spec*p.tbst_sens;
    p2.case_findingHHC_Ls(3,:,hhc_slum) = p.hhc_a10_enhanced_spec*p.tbst_sens;
    p2.case_findingHHC_Ls(4,:,hhc_slum) = p.hhc_a15_enhanced_spec*p.tbst_sens;

    p2.case_findingHHC_I(1,:,hhc_slum) = p.hhc_a0_enhanced_sens;
    p2.case_findingHHC_I(2,:,hhc_slum) = p.hhc_a5_enhanced_sens;
    p2.case_findingHHC_I(3,:,hhc_slum) = p.hhc_a10_enhanced_sens;
    p2.case_findingHHC_I(4,:,hhc_slum) = p.hhc_a15_enhanced_sens;
...
elseif intvn == 3
    ...
    p3.hiv_cov_screen=1;
     ...
     [r3, p3]=get_country_pars(r3,p3,p.country,'noTPT_enhanced','hhc_plhiv');
    ...
    p3.case_findingPLHIV_I(1) =p.hiv_a0_enhanced_noart_sens;
    p3.case_findingPLHIV_I(2) =p.hiv_a5_enhanced_noart_sens;
    p3.case_findingPLHIV_I(3) =p.hiv_a10_enhanced_noart_sens;
    p3.case_findingPLHIV_I(4) =p.hiv_a15_enhanced_noart_sens;
    ...
    % HHC
    p3.case_findingHHC_U(1,:,hhc_slum) = p.hhc_a0_enhanced_spec;
    p3.case_findingHHC_U(2,:,hhc_slum) = p.hhc_a5_enhanced_spec*(1-p.tbst_spec);
    p3.case_findingHHC_U(3,:,hhc_slum) = p.hhc_a10_enhanced_spec*(1-p.tbst_spec);
    p3.case_findingHHC_U(4,:,hhc_slum) = p.hhc_a15_enhanced_spec*(1-p.tbst_spec);

    p3.case_findingHHC_Lf(1,:,hhc_slum) = p.hhc_a0_enhanced_spec;
    p3.case_findingHHC_Lf(2,:,hhc_slum) = p.hhc_a5_enhanced_spec*p.tbst_sens;
    p3.case_findingHHC_Lf(3,:,hhc_slum) = p.hhc_a10_enhanced_spec*p.tbst_sens;
    p3.case_findingHHC_Lf(4,:,hhc_slum) = p.hhc_a15_enhanced_spec*p.tbst_sens;

    p3.case_findingHHC_Ls(1,:,hhc_slum) = p.hhc_a0_enhanced_spec;
    p3.case_findingHHC_Ls(2,:,hhc_slum) = p.hhc_a5_enhanced_spec*p.tbst_sens;
    p3.case_findingHHC_Ls(3,:,hhc_slum) = p.hhc_a10_enhanced_spec*p.tbst_sens;
    p3.case_findingHHC_Ls(4,:,hhc_slum) = p.hhc_a15_enhanced_spec*p.tbst_sens;

    p3.case_findingHHC_I(1,:,hhc_slum) = p.hhc_a0_enhanced_sens;
    p3.case_findingHHC_I(2,:,hhc_slum) = p.hhc_a5_enhanced_sens;
    p3.case_findingHHC_I(3,:,hhc_slum) = p.hhc_a10_enhanced_sens;
    p3.case_findingHHC_I(4,:,hhc_slum) = p.hhc_a15_enhanced_sens;
...
elseif intvn == 4
    ...
    p4.hhc_a_cov_tpt=[p.hhcovu5,p.hhcov,p.hhcov,p.hhcov];
    ...
    [r4, p4]=get_country_pars(r4,p4,p.country,'noTPT_enhanced','slum');
    ...
    p4.case_findingPLHIV_I(1) =p.hiv_a0_enhanced_noart_sens;
    p4.case_findingPLHIV_I(2) =p.hiv_a5_enhanced_noart_sens;
    p4.case_findingPLHIV_I(3) =p.hiv_a10_enhanced_noart_sens;
    p4.case_findingPLHIV_I(4) =p.hiv_a15_enhanced_noart_sens;
    ...
    % HHC
    p4.case_findingHHC_U(1,:,hhc_slum) = p.hhc_a0_enhanced_spec;
    p4.case_findingHHC_U(2,:,hhc_slum) = p.hhc_a5_enhanced_spec*(1-p.tbst_spec);
    p4.case_findingHHC_U(3,:,hhc_slum) = p.hhc_a10_enhanced_spec*(1-p.tbst_spec);
    p4.case_findingHHC_U(4,:,hhc_slum) = p.hhc_a15_enhanced_spec*(1-p.tbst_spec);

    p4.case_findingHHC_Lf(1,:,hhc_slum) = p.hhc_a0_enhanced_spec;
    p4.case_findingHHC_Lf(2,:,hhc_slum) = p.hhc_a5_enhanced_spec*p.tbst_sens;
    p4.case_findingHHC_Lf(3,:,hhc_slum) = p.hhc_a10_enhanced_spec*p.tbst_sens;
    p4.case_findingHHC_Lf(4,:,hhc_slum) = p.hhc_a15_enhanced_spec*p.tbst_sens;

    p4.case_findingHHC_Ls(1,:,hhc_slum) = p.hhc_a0_enhanced_spec;
    p4.case_findingHHC_Ls(2,:,hhc_slum) = p.hhc_a5_enhanced_spec*p.tbst_sens;
    p4.case_findingHHC_Ls(3,:,hhc_slum) = p.hhc_a10_enhanced_spec*p.tbst_sens;
    p4.case_findingHHC_Ls(4,:,hhc_slum) = p.hhc_a15_enhanced_spec*p.tbst_sens;

    p4.case_findingHHC_I(1,:,hhc_slum) = p.hhc_a0_enhanced_sens;
    p4.case_findingHHC_I(2,:,hhc_slum) = p.hhc_a5_enhanced_sens;
    p4.case_findingHHC_I(3,:,hhc_slum) = p.hhc_a10_enhanced_sens;
    p4.case_findingHHC_I(4,:,hhc_slum) = p.hhc_a15_enhanced_sens;
