function out = goveqs_scaleup_itv_noTST(t, in, M0, M1, times, i, s,r, p, sel, agg,hivpoints)
    ...
    Mt.linHHC = M0.linHHC + scale*(M1.linHHC-M0.linHHC);
    ...
    Mt.screen_hhc=M0.screen_hhc + scale*(M1.screen_hhc-M0.screen_hhc);
    
out = governing_equations_itv2_noTST(t, in, Mt, i, s,r,p, sel, agg, p.growth,hivpoints);
