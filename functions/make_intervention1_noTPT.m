...
function M = make_intervention1_noTPT(p, r, i,s, gps,intvn)
...
elseif intvn == 2
    ...
    p2.case_findingHHC_U(1,1,1) = p.hhc_a0_basic_spec;
    p2.case_findingHHC_U(2,1,1) = p.hhc_a5_basic_spec*(1-p.tst_spec);
    p2.case_findingHHC_U(3,1,1) = p.hhc_a10_basic_spec*(1-p.tst_spec);
    p2.case_findingHHC_U(4,1,1) = p.hhc_a15_basic_spec*(1-p.tst_spec);

    p2.case_findingHHC_Lf(1,1,1) = p.hhc_a0_basic_spec;
    p2.case_findingHHC_Lf(2,1,1) = p.hhc_a5_basic_spec*p.tst_sens;
    p2.case_findingHHC_Lf(3,1,1) = p.hhc_a10_basic_spec*p.tst_sens;
    p2.case_findingHHC_Lf(4,1,1) = p.hhc_a15_basic_spec*p.tst_sens;

    p2.case_findingHHC_Ls(1,1,1) = p.hhc_a0_basic_spec;
    p2.case_findingHHC_Ls(2,1,1) = p.hhc_a5_basic_spec*p.tst_sens;
    p2.case_findingHHC_Ls(3,1,1) = p.hhc_a10_basic_spec*p.tst_sens;
    p2.case_findingHHC_Ls(4,1,1) = p.hhc_a15_basic_spec*p.tst_sens;

    p2.case_findingHHC_I(1,1,1) = p.hhc_a0_basic_sens;
    p2.case_findingHHC_I(2,1,1) = p.hhc_a5_basic_sens;
    p2.case_findingHHC_I(3,1,1) = p.hhc_a10_basic_sens;
    p2.case_findingHHC_I(4,1,1) = p.hhc_a15_basic_sens;
...
elseif intvn == 3
    ...
    % HHC
    p3.case_findingHHC_U(1,1,1) = p.hhc_a0_basic_spec;
    p3.case_findingHHC_U(2,1,1) = p.hhc_a5_basic_spec*(1-p.tst_spec);
    p3.case_findingHHC_U(3,1,1) = p.hhc_a10_basic_spec*(1-p.tst_spec);
    p3.case_findingHHC_U(4,1,1) = p.hhc_a15_basic_spec*(1-p.tst_spec);

    p3.case_findingHHC_Lf(1,1,1) = p.hhc_a0_basic_spec;
    p3.case_findingHHC_Lf(2,1,1) = p.hhc_a5_basic_spec*p.tst_sens;
    p3.case_findingHHC_Lf(3,1,1) = p.hhc_a10_basic_spec*p.tst_sens;
    p3.case_findingHHC_Lf(4,1,1) = p.hhc_a15_basic_spec*p.tst_sens;

    p3.case_findingHHC_Ls(1,1,1) = p.hhc_a0_basic_spec;
    p3.case_findingHHC_Ls(2,1,1) = p.hhc_a5_basic_spec*p.tst_sens;
    p3.case_findingHHC_Ls(3,1,1) = p.hhc_a10_basic_spec*p.tst_sens;
    p3.case_findingHHC_Ls(4,1,1) = p.hhc_a15_basic_spec*p.tst_sens;

    p3.case_findingHHC_I(1,1,1) = p.hhc_a0_basic_sens;
    p3.case_findingHHC_I(2,1,1) = p.hhc_a5_basic_sens;
    p3.case_findingHHC_I(3,1,1) = p.hhc_a10_basic_sens;
    p3.case_findingHHC_I(4,1,1) = p.hhc_a15_basic_sens;
...
elseif intvn == 4
    ...
    % HHC
    p4.case_findingHHC_U(1,1,1) = p.hhc_a0_basic_spec;
    p4.case_findingHHC_U(2,1,1) = p.hhc_a5_basic_spec*(1-p.tst_spec);
    p4.case_findingHHC_U(3,1,1) = p.hhc_a10_basic_spec*(1-p.tst_spec);
    p4.case_findingHHC_U(4,1,1) = p.hhc_a15_basic_spec*(1-p.tst_spec);

    p4.case_findingHHC_Lf(1,1,1) = p.hhc_a0_basic_spec;
    p4.case_findingHHC_Lf(2,1,1) = p.hhc_a5_basic_spec*p.tst_sens;
    p4.case_findingHHC_Lf(3,1,1) = p.hhc_a10_basic_spec*p.tst_sens;
    p4.case_findingHHC_Lf(4,1,1) = p.hhc_a15_basic_spec*p.tst_sens;

    p4.case_findingHHC_Ls(1,1,1) = p.hhc_a0_basic_spec;
    p4.case_findingHHC_Ls(2,1,1) = p.hhc_a5_basic_spec*p.tst_sens;
    p4.case_findingHHC_Ls(3,1,1) = p.hhc_a10_basic_spec*p.tst_sens;
    p4.case_findingHHC_Ls(4,1,1) = p.hhc_a15_basic_spec*p.tst_sens;

    p4.case_findingHHC_I(1,1,1) = p.hhc_a0_basic_sens;
    p4.case_findingHHC_I(2,1,1) = p.hhc_a5_basic_sens;
    p4.case_findingHHC_I(3,1,1) = p.hhc_a10_basic_sens;
    p4.case_findingHHC_I(4,1,1) = p.hhc_a15_basic_sens;
