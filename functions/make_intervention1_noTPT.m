...
elseif intvn == 1
    ...
    [r1, p1]=get_country_pars(r1,p1,p.country,'noTPT_basic','plhiv');
...
elseif intvn == 2
    ...
    [r2, p2]=get_country_pars(r2,p2,p.country,'noTPT_basic','hhc');
...
elseif intvn == 3
    ...
    [r3, p3]=get_country_pars(r3,p3,p.country,'noTPT_basic','hhc_plhiv');
...
elseif intvn == 4
   ...
   [r4, p4]=get_country_pars(r4,p4,p.country,'noTPT_basic','slum');
